...
///   -> Set the script's Axis to MouseY in the inspector. (You want the camera to tilt up and down like a head. The character already turns.)
    ...
    function Update ()
    {
        ...
        if (Input.GetAxis("Vertical"))
        {
            ...
            transform.localPosition += cameraReference.transform.localRotation * Vector3(0,0,translationZ/2.5f);
        }
        ...
        if (Input.GetAxis("Horizontal"))
        {
            ...
            transform.localPosition += cameraReference.transform.localRotation * Vector3(translationX/2.5f,0,0);
        }
